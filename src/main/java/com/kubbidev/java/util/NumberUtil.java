...
public final class NumberUtil {
    ...
    private NumberUtil() {
        throw new AssertionError("No com.kubbidev.java.util.NumberUtil instances for you!");
    }
    ...
    public static Integer toPositiveIntOrNull(@Nullable String str) {
        Integer value = NumberUtil.toIntOrNull(str);
    ...
    public static Long toPositiveLongOrNull(@Nullable String str) {
        Long value = NumberUtil.toLongOrNull(str);
        if (value == null || value <= 0) {
            return null;
        }
        return value;
